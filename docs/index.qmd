...
All code used in this report is publicly available on [GitHub](https://github.com/vdelimad/predicting-crime-with-green-space-data).
::: 
...
![Heatmap of the Tree Equity Score for the census blocks in the City of New York generated using @city_of_new_york_2020_2022 and @green_space_challenge_tree_2023](../images/ny_tree_equity_score.png){height="300px" #fig-heatmap}
